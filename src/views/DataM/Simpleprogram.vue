        ...
        <div class="Simpleprogrambody" :style="{height:Height}">
          <vxe-table border height="auto" :data="tableData">
            ...
            <vxe-table-column
              ...
              show-overflow
            />
            <vxe-table-column field="illegalDeed" title="违法行为" align="center" />
...
export default class Simpleprogram extends Vue {
  [x: string]: any
  public form!: any
  ...
  private gettabledata(obj: any) {
        this.DataM.getprogramTable(obj, true).then((res: any) => {
              console.log(res)
