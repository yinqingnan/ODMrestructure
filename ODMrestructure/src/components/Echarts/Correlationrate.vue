 ...
 * @Descripttion: 案件关联率
 * @Autor: yqn
 * @Date: 2020-12-29 15:24:58
 * @LastEditTime: 2020-12-30 17:21:44
 * @FilePath: \src\components\Echarts\Correlationrate.vue
-->
<template>
  <div>
    <!-- <h2>Correlationrate</h2> -->
    <div id="chart1" style="100%;height:330px"></div>
  </div>
</template>
...
export default class Correlationrate extends Vue {
  ...
  public init() {
    // 执行图表对象的初始化
    this.chartDom = echarts.init(document.getElementById("chart1") as HTMLCanvasElement)
    // 为图标表对象赋值
